CREATE OR REPLACE VIEW public.vw_project_summary WITH (security_invoker = true) AS
SELECT
...
CREATE OR REPLACE VIEW public.vw_monthly_completion_trend WITH (security_invoker = true) AS
SELECT
...
CREATE OR REPLACE VIEW public.vw_site_performance WITH (security_invoker = true) AS
SELECT
